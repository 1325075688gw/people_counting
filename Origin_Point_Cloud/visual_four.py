...
class FourPlots(QWidget):
    ...
    def __init__(self,loc_pos,point_cloud_show_queue,cluster_show_queue):
        super().__init__()
    ...
    def initUI(self):
        ...
        self.setGeometry(50,50,2*950*(common.xmax-common.xmin)/common.ymax,950)
        ...
        #设置子图坐标范围
        self.track_plt.setRange(xRange=[common.xmin,common.xmax],yRange=[common.ymin,common.ymax],padding=0)
        self.center_plt.setRange(xRange=[common.xmin,common.xmax],yRange=[common.ymin,common.ymax],padding=0)
        self.cluster_plt.setRange(xRange=[common.xmin,common.xmax],yRange=[common.ymin,common.ymax],padding=0)
        self.point_plt.setRange(xRange=[common.xmin,common.xmax],yRange=[common.ymin,common.ymax],padding=0)
        #将子图添加到主窗口
...
def visual4plots(loc_pos,point_cloud_show_queue,cluster_show_queue):
    qapp = QtWidgets.QApplication(sys.argv)
    app = FourPlots(loc_pos,point_cloud_show_queue,cluster_show_queue)
    app.show()
    qapp.exec_()