...
from common import xmin,xmax,ymax,ymin,detection_range
...
class ClusterWindow():
    ...
    def __init__(self, x_range, y_range,point_cloud_show_queue,cluster_show_queue):
        ...
        self.cluster_plot.setRange(xRange=[xmin, xmax], yRange=[ymin, 12], padding=0)
        ...
        self.frame_num_text.setPos(-0.2, 12)
        ...
        self.origin_plot.setRange(xRange=[xmin, xmax], yRange=[0, 12], padding=0)
