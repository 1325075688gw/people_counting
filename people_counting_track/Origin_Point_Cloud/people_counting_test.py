...
def read_data():
    pathdir='data/data_7_30，ODS6m,3人姿态，两块板子，第1次/'
...
def start_visual():
    ...
    # multiprocessing.Process(target=run_visual,args=(common.xmin,common.xmax,common.ymin,common.ymax,common.detection_range,common.loc_pos,)).start()
