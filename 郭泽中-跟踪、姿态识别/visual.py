...
class VisualModule(QWidget):
    ...
    def __init__(self):
        ...
        self.xmin=common.xmin
        self.xmax=common.xmax
        self.detection_range=common.detection_range
    ...
    def initUI(self):
        ...
        height=width*self.detection_range/(self.xmax-self.xmin)
        ...
        self.plt.setRange(xRange=[self.xmin,self.xmax],yRange=[0,self.detection_range],padding=0)
    ...
    def _update_canvas(self):
        ...
        locations,postures=common.loc_pos.get()
        ...
        for person in locations:
            ...
            text.setPos(locations[person][0]-0.2,locations[person][1]+0.18)
