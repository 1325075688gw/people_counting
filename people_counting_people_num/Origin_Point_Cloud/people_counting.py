...
def run_system():
    ...
    UartParseSDK.init_parameters(-1,r'./data/data_7_28，ODS6m,10人，两块板子，第3次',800)

    UartParseSDK.show_frame(3,common.xmin,common.xmax,common.ymin,common.ymax,common.detection_range)
